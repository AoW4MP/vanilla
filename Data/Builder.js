...
const errorImage = "/vanilla/Icons/Text/exclamationpoint.png";
...
function createStatusEffectTooltip(effectData, handlerType = "status") {
    ...
    image.setAttribute("src", "/vanilla/Icons/UnitIcons/" + effectData.icon + ".png");
    ...
    for (let i = 0; i < list.length; i++) {
        ...
        switch (cardType) {
            case "unitTomeIcon":
                ...
                const lookUpTome = findBy(jsonTomes, "id", splitIcon[1]);
                btn.innerHTML =
                    '<img style="float:left;" src="/vanilla/Icons/TomeIcons/' +
                    lookUpTome.icon +
                    ".png\" width='25px'\">" +
...
function SetCollapsibleButtonsAndDivs(overwrite, list, cardType) {
    ...
    switch (cardType) {
        ...
        case "heroTrait":
            ...
            break;
        case "freeCity":
            showFreeCityUpgradeSetFromList(list, overwrite);
            break;
        case "heroGov":
...
function addUnitTypeIcon(a, holder, origin) {
    ...
    imag.setAttribute("src", "/vanilla/Icons/UnitIcons/" + iconsrc + ".png");
    imag.setAttribute("onerror", "this.setAttribute('src','" + errorImage + "')");
    imag.setAttribute("width", "40");
    imag.setAttribute("height", "40");

    spa.innerHTML =
        '<img style="float:left; height:30px; width:30px" src="/vanilla/Icons/UnitIcons/' +
        iconsrc +
    ...
    if (origin !== "") {
        ...
        if (roleNames.includes(iconName)) {
            ...
            unitRole.setAttribute("src", `/vanilla/Icons/Text/${clearname}.png`);
        }
    }
...
function addAbilityslot(a, holder, list, enchant, uniqueMedal) {
                        ...
                        if ("type2" in jsonEnchantments[k].attack[t]) {
                            if (jsonEnchantments[k].attack[t].type2.indexOf("*") != -1) {
                                if (
                                    ...
                                    abilityEncht +=
                                        '<bullet><img src="/vanilla/Icons/SpellIcons/' +
    ...
    let abilityIconType = "";
    imag.setAttribute("src", "/vanilla/Icons/UnitIcons/" + abilityIcon + ".png");

    abilityIconType = GetAbilityBackground(abilityDam);

    imag.setAttribute(
        "style",
        'background-image: url("/vanilla/Icons/Interface/' +
            abilityIconType +
    ...
    if (Cooldown != "") {
        ...
        imageExtra.setAttribute("src", "/vanilla/Icons/Text/turn.png");
    ...
    if (Once != "") {
        imageExtra = document.createElement("IMG");
        imageExtra.setAttribute("src", "/vanilla/Icons/Text/once.png");
        imageExtra.setAttribute("style", " position: absolute; height: 18px; left: 0px;bottom: 4px;");
        btn.append(imageExtra);
    }
    ...
    if (Melee != "") {
        imageExtra = document.createElement("IMG");
        imageExtra.setAttribute("src", "/vanilla/Icons/Text/armor_small.png");
    ...
    if (Magic != "") {
        imageExtra = document.createElement("IMG");
        imageExtra.setAttribute("src", "/vanilla/Icons/Text/resistance_small.png");
...
function GetAbilityToolTip(ability, uniqueMedal) {
    ...
    abilityIcon.setAttribute("src", "/vanilla/Icons/UnitIcons/" + ability.icon + ".png");
    abilityIcon.style.backgroundImage = "url(/vanilla/Icons/Interface/" + abilityBackground + ".png";
...
function addUniquePassiveSlot(enchantment, descr, div, overwrite) {
    ...
    imag.setAttribute("src", "/vanilla/Icons/SpellIcons/" + abilityIcon + ".png");
    imag.setAttribute("onerror", "this.setAttribute('src','" + errorImage + "')");
    imag.setAttribute("width", "40");
    imag.setAttribute("height", "40");
...
function CreatePassiveSlotToolTip(abilityIcon, abilityName, abilityDescr) {
    ...
    spa.innerHTML =
        '<div class="abilityHighLighter"><img style="float:left; position:relative; top:-7px; height:30px; width:30px" src="/vanilla/Icons/UnitIcons/' +
        abilityIcon +
    ...
    for (let j = 0; j < jsonUnitAbilities.length; j++) {
        if (a === jsonUnitAbilities[j].slug) {
            ...
            if (a.indexOf("Frost") !== -1) {
                imag.setAttribute("src", "/vanilla/Icons/Text/frost_resistance.png");
                spa.innerHTML += "<defensefrost></defensefrost>";
            }
            if (a.indexOf("Blight") !== -1) {
                imag.setAttribute("src", "/vanilla/Icons/Text/blight_resistance.png");
                spa.innerHTML += "<defenseblight></defenseblight>";
            }
            if (a.indexOf("Physical") !== -1) {
                imag.setAttribute("src", "/vanilla/Icons/Text/physical_resistance.png");
                spa.innerHTML += "<defensephysical></defensephysical>";
            }
            if (a.indexOf("Fire") !== -1) {
                imag.setAttribute("src", "/vanilla/Icons/Text/fire_resistance.png");
                spa.innerHTML += "<defensefire></defensefire>";
            }
            if (a.indexOf("Spirit") !== -1) {
                imag.setAttribute("src", "/vanilla/Icons/Text/spirit_resistance.png");
                spa.innerHTML += "<defensespirit></defensespirit>";
            }

            if (a.indexOf("Shock") !== -1) {
                imag.setAttribute("src", "/vanilla/Icons/Text/lightning_resistance.png");
...
function addstatusResistanceSlot(a, holder) {
    ...
    imag.setAttribute("src", "/vanilla/Icons/Text/status_resistance.png");
...
async function showFreeCityUpgradeSetFromList(list, divID) {
    let cards = await spawnSpellCards(list, divID);

    for (let i = 0; i < list.length; i++) {
        showFreeCityUpgrade(list[i].id, cards[i]);
    }
}
...
async function showFreeCityUpgradeSets() {
    let list = [];
    list = findFreeCitySets();

    SetCollapsibleButtonsAndDivs("Free City Sets", list, "freeCity");
}
...
function showUnit(unitID, subcultureCheck, resID, divOrigin) {
    ...
    imagelink.setAttribute("src", "/vanilla/PreviewsAvif/" + unitEN.id + ".avif");
    if (imagelink.getAttribute("src") === "/vanilla/PreviewsAvif/undefined") {
        imagelink.setAttribute("src", "/vanilla/PreviewsAvif/abductor.avif");
    }
    // }
    ...
    if (MountedSpecialList.includes(unitID) || CheckIfOptionalCavalry(unitID)) {
        ...
        imag = document.createElement("IMG");
        imag.setAttribute("src", "/vanilla/Icons/Text/MountInteraction.png");
    ...
    if ("combat_speed" in unitEN) {
        ...
        img.setAttribute("src", "/vanilla/Icons/Text/combat_speed.png");
    ...
    if (CheckIfFormUnit(unitEN)) {
        ...
        imag.setAttribute("src", "/vanilla/Icons/FactionCreation/human.png");

        imag.setAttribute("width", "40");
        imag.setAttribute("height", "40");

        span.innerHTML =
            '<img style="float:left; height:30px; width:30px" src="/vanilla/Icons/FactionCreation/human.png"><p style="color: #d7c297" class="abilityHighLighter">' +
...
function backtrackUnitOrigins(unitData, name, holder) {
    ...
    if (culture != "thing") {
        ...
        const imgSrc = `/vanilla/Icons/Text/${culture}.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/${capitalized}Units.html`;
    ...
    if (subculture != "") {
        ...
        const imgSrc = `/vanilla/Icons/Text/${subculture}.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        //  const link = `/vanilla/HTML/${capitalized}Units.html`;
    ...
    for (let x = 0; x < tomes.length; x++) {
        ...
        const imgSrc = `/vanilla/Icons/TomeIcons/${tomes[x].icon}.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/Spells.html?tome=${tomes[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < spells.length; x++) {
        ...
        let imageSRC;
        let imageLinkName;
        if (spells[x].icon != undefined && !incorrectIconOverrideList.includes(spells[x].id)) {
            imageLinkName = spells[x].icon;
            imageSRC = "/vanilla/Icons/SpellIcons/" + imageLinkName + ".png";
        } else {
            imageLinkName = spells[x].id;
            imageSRC = "/vanilla/Icons/SummonIcons/" + imageLinkName + ".png";
        }
        // let imageLinkName =  spells[x].icon?  spells[x].icon :  spells[x].id;

        // const imgSrc = `/vanilla/Icons/SpellIcons/${imageLinkName}.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/Spells.html?spell=${spells[x].id}`;
        ...
        createFoundUnitInHereIcon(holderOrigin, imageSRC, imgFallbackSrc, link, tooltipText);
    ...
    for (let x = 0; x < siege.length; x++) {
        ...
        const imgSrc = `/vanilla/Icons/SiegeProjectIcons/${siege[x].icon}.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/Spells.html?siege=${siege[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < struc.length; x++) {
        ...
        const imgSrc = `/vanilla/Icons/UpgradeIcons/${struc[x].icon}.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/Spells.html?structure=${struc[x].id}`;
        const miniIcon = document.createElement("div");
        miniIcon.className = "MiniIconCheck";
    ...
    for (let x = 0; x < traitFound.length; x++) {
        ...
        // if from GEN, use FACTIONCREATION folder
        const imgSrc = `/vanilla/Icons/FactionCreation/${traitFound[x].id}.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/Spells.html?trait=${traitFound[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < wonder.length; x++) {
        ...
        const imgSrc = `/vanilla/Icons/StructurePics/${wonder[x].id}.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/Spells.html?wonder=${wonder[x].id}`;
    ...
    for (let x = 0; x < tree.length; x++) {
        ...
        const imgSrc = `/vanilla/Icons/EmpireProgressionIcons/${tree[x].icon}.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/EmpireTree.html`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < unitAbility.length; x++) {
        ...
        const imgSrc =
            unitAbility[0] != ""
                ? `/vanilla/Icons/UnitIcons/${unitAbility[x][1].icon}.png`
                : `/vanilla/Icons/UnitIcons/${unitAbility[x][1].icon}.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/Units.html?unit=${unitAbility[x][0].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < infusion.length; x++) {
        ...
        const imgSrc = `/vanilla/Icons/UnitIcons/` + infusion[x].icon + `.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/Infusions.html`;
        const miniIcon = document.createElement("div");
        miniIcon.className = "MiniIconCheck";
    ...
    for (let x = 0; x < heroSkill.length; x++) {
        ...
        const imgSrc = `/vanilla/Icons/UnitIcons/${heroSkill[x].icon}.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/Spells.html?skill=${heroSkill[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    for (let x = 0; x < governance.length; x++) {
        ...
        const imgSrc = `/vanilla/Icons/GovernanceIcons/${governance[x].icon}.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/Spells.html?governance=${governance[x].id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    if (evolve != "") {
        ...
        const imgSrc = `/vanilla/Icons/Text/evolve.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/Units.html?unit=${evolve.id}`;
        createFoundUnitInHereIcon(holderOrigin, imgSrc, imgFallbackSrc, link, tooltipText);
    }
    ...
    if (freecity.length > 0) {
        ...
        const imgSrc = `/vanilla/Icons/Text/free_city.png`;
        const imgFallbackSrc = `/vanilla/Icons/Text/mp.png`;
        const link = `/vanilla/HTML/FreeCities.html`;
        const miniIcon = document.createElement("div");
        miniIcon.className = "MiniIconCheck";
        miniIcon.innerHTML = "<rally></rally>";
...
function addLevelUpInfo(units, a, holder) {
    ...
    if (evolveTarget) {
        const levelText = `<bullet> Evolves/Promotes into <hyperlink><a href="/vanilla/HTML/Units.html?unit=${evolveTarget}" target="_blank">${lookupUnit(evolveTarget)}</a></hyperlink></bullet>`;
...
function showSiegeProject(id, showOrigin, divOrigin) {
    ...
    if (siegeProject != undefined) {
        ...
        imagelink.setAttribute("src", "/vanilla/Icons/SiegeProjectIcons/" + siegeProject.icon + ".png");
...
function showExtraTomeSkill(skill, showOrigin, divOrigin) {
    ...
    imagelink.setAttribute("src", "/vanilla/Icons/SpellIcons/" + imageLinkName + ".png");
...
function showEmpireUpgrade(skill, showOrigin, divOrigin) {
    ...
    let imageLinkName = skill.name.replaceAll(" ", "_").toLowerCase();
    imagelink.setAttribute("src", "/vanilla/Icons/ExtraIcons/" + imageLinkName + ".png");
...
function showTome(a, divOrigin) {
    ...
    imagelink.setAttribute("src", "/vanilla/Icons/TomeIcons/" + tomeEN.icon + ".png");
...
function createTooltipForEnchant(item) {
    ...
    image.setAttribute("src", "/vanilla/Icons/SpellIcons/" + item.icon + ".png");
...
function SetEnchantment(evt) {
    if (!isInArray(evt.currentTarget.activeEnchantList, evt.currentTarget.enchant)) {
        ...
        image.setAttribute("src", "/vanilla/Icons/SpellIcons/" + evt.currentTarget.enchant.icon + ".png");
...
function showStructure(a, showOrigin, divOrigin) {
    ...
    imagelink.setAttribute("src", "/vanilla/Icons/UpgradeIcons/" + structureLoc.icon + ".png");
...
function addUnlockableUnitsToStructure(a, keyword, unitList, descriptionDiv, unitTypesDiv) {
    if (a.indexOf(keyword) !== -1) {
        ...
        for (let i = 0; i < unitList.length; i++) {
            ...
            div.innerHTML =
                "<bullet>" +
                '<a href="/vanilla/HTML/Units.html?unit=' +
                unitList[i] +
                '" target="_blank">' +
...
function showCosmicHappening(a, divOrigin) {
 ...
 for (let j= 0; j <jsonCosmicHappenings.length;j++) {
        if (a === jsonCosmicHappenings[j].id) {
            ...
            imagelink.setAttribute("src", "/vanilla/Icons/CosmicHappenings/category_icon_" + categoryLink + ".png");
            ...
            preview.setAttribute("style", 'background-image: url("/vanilla/Icons/CosmicHappenings/' + imagePos);

            preview.setAttribute("src", "/vanilla/Icons/Interface/Runecircle.png");
...
function showWorldStructure(a, divOrigin) {
    ...
    if (structure.type.indexOf("wonder") != -1) {
        ...
        imagelink.setAttribute("src", "/vanilla/Icons/Text/landmark.png");

        imagelink.setAttribute("style", "background-image: none");
    } else if (structure.type == "Spawner") {
        imagelink.setAttribute("src", "/vanilla/Icons/Interface/Header/Infestation.png");
        imagelink.setAttribute("style", "background-image: none");
    } else {
        imagelink.setAttribute("src", "/vanilla/Icons/WorldStructures/" + a + ".png");
    ...
    let preview = divOrigin.querySelector("#structurepreview");
    preview.setAttribute("src", "/vanilla/Icons/StructurePics/" + a + ".png");
...
function showInfusionListEntrySmall(infusion, selectedTreeFilter, selectedSubTreeFilter, selectedMMTreeFilter) {
    ...
    icon.setAttribute("src", "/vanilla/Icons/UnitIcons/" + infusion.icon + ".png");
    ...
    for (const entry of weapons) {
        ...
        const img = document.createElement("img");
        img.setAttribute("src", "/vanilla/Icons/ItemForge/" + entry.toLowerCase() + ".png");
...
function FindCombatEnchantment(combatID) {
    ...
    let div = document.createElement("DIV");
    div.innerHTML =
        '<img style="float:left; height:80px; padding:10px" src="/vanilla/Icons/CombatEnchantments/' +
...
function showDestinyTrait(trait, divOrigin) {
    ...
    if (traitEN != undefined) {
        ...
        imagelink.setAttribute("src", "/vanilla/Icons/EmpireProgressionIcons/" + traitEN.id + ".png");
...
function showEmpireTree(a, divOrigin) {
    ...
    for (let j= 0; j<jsonEmpire.length;j++) {
        ...
        if (a === jsonEmpire[j].id) {
            ...
            imagelink.setAttribute("src", "/vanilla/Icons/EmpireProgressionIcons/" + jsonEmpire[j].icon + ".png");
...
function showUnitUnlock(a, divOrigin) {
    ...
    imagelink.setAttribute("src", "/vanilla/Icons/UnitUnlockIcons/" + a.unit_slug + ".png");
...
function showSpell(a, showOrigin, divOrigin) {
    ...
    description += "<br><greenText>Affected Unit Types: </greenText><br>";
        ...
        let imageLinkName = "";
        let imageSRC;
        if (spellFound.icon != undefined && !incorrectIconOverrideList.includes(spellFoundEN.id)) {
...
function showItem(itemLoc, divOrigin) {
    ...
    tomeOriginIcon.setAttribute("src", "/vanilla/Icons/UnitIcons/" + itemLoc.icon + ".png");
}
...
function showTraitSetup(currentTrait, divOrigin, loc) {
    ...
    if ("extraLookup" in currentTrait || iconLink == undefined) {
        ...
        imagelink.setAttribute("src", "/vanilla/Icons/FactionCreation/" + iconLink + ".png");
    } else {
        if (iconLink.startsWith("_")) {
            iconLink = iconLink.split("_").slice(1).join("_");
        }
        imagelink.setAttribute("src", "/vanilla/Icons/TraitIcons/" + iconLink + ".png");
    }
...
function showFreeCityUpgrade(a, divOrigin) {
    let thisFreeCity = jsonFreeCities.find((entry) => entry.id === a);

    const modName = divOrigin.querySelector("#modname");
    // lookup name and description from lookup

    const valueLookup = findBy(jsonAllFromPOLocalized, "id", thisFreeCity.lookup);
    ...
    const descriptionDiv = divOrigin.querySelector("#moddescription");

    descriptionDiv.innerHTML = description;
    const typesDiv = divOrigin.querySelector("#affectUnitTypes");
    ...
    for (const entry of thisFreeCityPart) {
        ...
        if ("enchantments" in entry) {
            ...
            for (const unit of entries) {
                ...
                div.setAttribute("style", "margin-right: 20px;");
                div.innerHTML =
                    '<a href="/vanilla/HTML/Spells.html?spell=' +
                    unit +
                    '" target="_blank">' +
        ...
        if ("buildings" in entry) {
            ...
            for (const unit of entries) {
                ...
                div.setAttribute("style", "margin-right: 20px;");
                div.innerHTML =
                    '<a href="/vanilla/HTML/Spells.html?structure=' +
                    unit +
                    '" target="_blank">' +
...
function showHeroTrait(a, divOrigin) {
    ...
    let imagelink = divOrigin.querySelector("#modicon");
    imagelink.setAttribute("src", "/vanilla/Icons/AmbitionIcons/" + thisAmbition.icon + ".png");
    imagelink.setAttribute("style", "background-image:none");
...
function showHeroGov(data, check, divOrigin) {
    ...
    let imagelink = divOrigin.querySelector("#modicon");
    imagelink.setAttribute("src", "/vanilla/Icons/GovernanceIcons/" + thisGovernance.icon + ".png");
    imagelink.setAttribute("style", "background-image:none");
    found = true;
}
...
function showSkill(a, checkInAbilities, icon_slug, category, level, group_name, divOrigin) {
    ...
    if (a.type === "signature") {
        ...
        imagelink.setAttribute("src", "/vanilla/Icons/UnitIcons/" + icon_slug + ".png");
...
function backtraceTomeOriginAndTier(spell, showorigin, modCard) {
    ...
    if (tomespells != undefined) {
        if (showorigin) {
            ...
            tomeOriginIcon.setAttribute("src", "/vanilla/Icons/TomeIcons/" + tomespells.icon + ".png");
            const wrap = tomeOriginName.innerHTML;
            tomeOriginName.innerHTML =
                '<a href="/vanilla/HTML/Spells.html?tome=' + tomespells.id + '" target="_blank">' + wrap + "</a>";
