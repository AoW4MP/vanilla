...
const dlcMap = {
    DRAGONLORDS: {
        src: "/vanilla/Icons/Text/DragonDawn.png",
        text: "Part of the Dragon Dawn DLC"
    },
    EMPIRESANDASHES: {
        src: "/vanilla/Icons/Text/EmpiresAshes.png",
        text: "Part of the Empires & Ashes DLC"
    },
    PRIMALFURY: {
        src: "/vanilla/Icons/Text/PrimalFury.png",
        text: "Part of the Primal Fury DLC"
    },
    ELDRITCHREALMS: {
        src: "/vanilla/Icons/Text/EldritchRealms.png",
        text: "Part of the Eldritch Realms DLC"
    },
    HERALDOFGLORY: {
        src: "/vanilla/Icons/Text/herald_of_glory.png",
        text: "Part of the Herald of Glory DLC"
    },
    WAYSOFWAR: {
        src: "/vanilla/Icons/Text/waysofwar.png",
        text: "Part of the Ways of War DLC"
    },
    GIANTKINGS: {
        src: "/vanilla/Icons/Text/GKLogo.png",
        text: "Part of the Giant Kings DLC"
    },
    ARCHONPROPHECY: {
        src: "/vanilla/Icons/Text/ArchonProphecy.png",
        text: "Part of the Archon Prophecy DLC"
    },
    COSMICWANDERER: {
        src: "/vanilla/Icons/Text/CosmicWanderer.png",
        text: "Part of the Cosmic Wanderer DLC"
    },
    THRONESOFBLOOD: {
        src: "/vanilla/Icons/Text/ThronesOfBlood.png",
        text: "Part of the Thrones of Blood DLC"
    }, RISEFROMRUIN: {
        src: "/vanilla/Icons/Text/RiseFromRuin.png",
        text: "Part of the Rise From Ruin DLC"
    }
};

async function GetAllData(selectedLang) {
    let basePathEN = `/vanilla/Data/EN/`;

    /*if (selectedLang == "BETA") {
        basePathEN = `/vanilla/Data/BETA/`;
    }
    */

    const basePathGen = `/vanilla/Data/GEN/`;
    // }
    //  const basePathEN = `/vanilla/Data/EN/`;
    const basePathLocal = `/vanilla/Data/${selectedLang}/`;
    ...
    try {
        const [dataGen, dataEN, dataLocal, templatesHtml] = await Promise.all([
            ...
            fetch("/vanilla/HTML/templates.html").then((res) => res.text())
        ]);
