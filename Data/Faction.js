...
function SelectSymbol(origin) {
    ...
    symbolElement.setAttribute("src", "/vanilla/Icons/Symbols/SigilIcons_" + origin + ".gif");
...
function SetSkillPathInfoSmall(buttonHolder, origin) {
    ...
    image.src = "/vanilla/Icons/UnitIcons/" + origin.icon + ".png"; // Set the image source to your image file
...
function SetTomePathInfoSmall(buttonHolder, origin) {
    ...
    image.src = "/vanilla/Icons/TomeIcons/" + origin.icon + ".png"; // Set the image source to your image file
...
function createImage(type, origin) {
    ...
    switch (type) {
        case "Tome":
            setImage(`/vanilla/Icons/TomeIcons/${origin.icon}.png`);
            break;
        case "Society1":
        case "Society2":
        case "FormTrait":
            setImage("/vanilla/Icons/TraitIcons/" + origin.icon + ".png");
            break;
        case "Culture":
        case "Origin":
        case "Form":
        ...
        case "SubType":
            ...
            break;
        case "Class":
            setImage(`/vanilla/Icons/Text/${origin.icon}.png`);
            break;
        case "Signature":
        case "Ascension":
            setImage(`/vanilla/Icons/UnitIcons/${origin.icon}.png`);
            break;
        case "Ambition":
            setImage(`/vanilla/Icons/AmbitionIcons/${origin.icon}.png`);
            break;
        /* case "Symbol":
            let symbolId = parseInt(origin, 10);
            if (symbolId < 10 && symbolId > 0) symbolId = "0" + symbolId;
            if (symbolId === 0) symbolId = 138;
            setImage(`/vanilla/Icons/Symbols/SigilIcons_${symbolId}.gif`);
            break;*/
    }
...
function getFactionIconPath(id) {
    ...
    return `/vanilla/Icons/FactionCreation/${cleanId}.png`;
}
...
function SetTomePreview(span, origin) {
    ...
    if ("initial_upgrades" in locOrigin) {
        ...
        for (let index = 0; index < locOrigin.initial_upgrades.length; index++) {
            ...
            span.innerHTML +=
                '<bullet> <img width="20px" src="/vanilla/Icons/UpgradeIcons/' +
                struc.icon +
                '.png">' +
                struc.name +
                "</bullet>";
    ...
    if ("skills" in origin) {
        ...
        for (let index = 0; index < origin.skills.length; index++) {
            ...
            if (
                ...
                if ("spell_slug" in origin.skills[index]) {
                    ...
                    if (iconLink == undefined || incorrectIconOverrideList.includes(spell.spell_slug)) {
                        iconLink = spell.id;
                        span.innerHTML +=
                            '<bullet> <img width="20px" src="/vanilla/Icons/SummonIcons/' +
                            iconLink +
                            '.png">' +
                            spell.name +
                            "</bullet>";
                        ...
                        span.innerHTML +=
                            '<bullet> <img width="20px" src="/vanilla/Icons/SpellIcons/' +
                            iconLink +
                            '.png">' +
                            spell.name +
                            "</bullet>";
                    ...
                    span.innerHTML +=
                        '<bullet> <img width="20px" src="/vanilla/Icons/UnitUnlockIcons/' +
            ...
            // siege
                ...
                span.innerHTML +=
                    '<bullet> <img width="20px" src="/vanilla/Icons/SiegeProjectIcons/' +
                    iconLink +
                    '.png">' +
                    siege.name +
                    "</bullet>";
            ...
            // empire upgrades
                ...
                span.innerHTML +=
                    '<bullet> <img width="20px" src="/vanilla/Icons/ExtraIcons/' +
                    imageLinkName +
                    '.png">' +
...
function CreateUnitIcon(listEntry, colorEntry) {
    ...
    allAbilities.innerHTML +=
        '<span style="font-size: 20px ;display:flex" ><img  src="/vanilla/Icons/Text/health.png" width="25 " height="25 ">' +
        listEntry.hp +
        '<img  src="/vanilla/Icons/Text/armor.png" width="25 " height="25 ">' +
        listEntry.armor +
        '<img src="/vanilla/Icons/Text/resistance.png" width="25 " height="25 ">' +
        listEntry.resistance +
        '<img src="/vanilla/Icons/Text/mp.png" width="25 " height="25 ">' +
        listEntry.mp +
        '<img src="/vanilla/Icons/Text/combat_speed.png" width="25 " height="25 ">' +
    ...
    for (let index = 0; index < list.length; index += 2) {
        for (let i = 0; i < jsonStructureUpgrades.length; i++) {
            if (jsonStructureUpgrades[i].id == list[index].upgrade_slug) {
                ...
                var smallIcon = document.createElement("img");
                smallIcon.setAttribute("src", "/vanilla/Icons/UpgradeIcons/" + jsonStructureUpgrades[i].icon + ".png");
    ...
    for (let index = 0; index < list.length; index += 2) {
        for (let i = 0; i < jsonHeroSkills.length; i++) {
            if (jsonHeroSkills[i].id === list[index].slug) {
                ...
                var smallIcon = document.createElement("img");
                smallIcon.setAttribute("src", "/vanilla/Icons/UnitIcons/" + jsonHeroSkills[i].icon + ".png");
                smallIcon.setAttribute("width", "20px");
                spell.appendChild(smallIcon);
                spell.appendChild(text);
...
function ShowPassivesOverview(list) {
    ...
    for (let index = 0; index < list.length; index += 2) {
        ...
        // var smallIcon = document.createElement("img");
        // smallIcon.setAttribute("src", "/vanilla/Icons/UnitIcons/" + jsonHeroSkills[index].icon + ".png");
        // smallIcon.setAttribute("width", "20px");
        //    spell.appendChild(smallIcon);
        spell.appendChild(text);
        section.append(spell);
    ...
    for (let index = 0; index < list.length; index += 2) {
        ...
        for (let i = 0; i < jsonSiegeProjects.length; i++) {
            ...
            if (jsonSiegeProjects[i].id == slug) {
                ...
                text.innerHTML = loc.name;
                var smallIcon = document.createElement("img");
                smallIcon.setAttribute("src", "/vanilla/Icons/SiegeProjectIcons/" + jsonSiegeProjects[i].icon + ".png");
                smallIcon.setAttribute("width", "20px");
                spell.appendChild(smallIcon);
                spell.appendChild(text);
                section.append(spell);
